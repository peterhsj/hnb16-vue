...
<script setup lang="ts">
  import type { ListItem, QueryFormPayload } from '@/types/queryAmendNotice'
  import type { DataTableHeader } from 'vuetify'
  import { computed, onMounted, ref, watch } from 'vue'
  import { getDatacList } from '@/api/queryAmendNotice'
  ...
  const amendNoticeNo = ref<string>('')
  // Lc Dialog
  ...
  const tableHeaders: DataTableHeader[] = [
    ...
    { title: '開立日期', key: 'issueDate', align: 'center', sortable: false, nowrap: true },
