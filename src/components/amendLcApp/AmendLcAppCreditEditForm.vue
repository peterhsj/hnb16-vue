        ...
        <v-table class="hnb__table hnb__table--vertical w-100" density="compact">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <v-text-field
                  v-model="form.openLoanApprovalNo"
                  color="teal-darken-2"
                  density="compact"
                  hide-details
                  variant="outlined"
              ...
              <td>
                <v-text-field
                  v-model="form.acceptanceLoanApprovalNo"
                  color="teal-darken-2"
                  density="compact"
                  hide-details
                  variant="outlined"
            ...
            <tr>
              ...
              <td>
                ...
                <v-checkbox
                  v-model="form.isAcceptanceFeeStampTaxDeducted"
                  color="cyan-darken-3"
                  density="compact"
                  hide-details
                >
            ...
            <tr>
              ...
              <td class="text-end">
                <v-text-field
                  v-model="form.depositMarginRate"
                  color="teal-darken-2"
                  density="compact"
                  hide-details
                  variant="outlined"
            ...
            <tr>
              ...
              <td colspan="3">
                <v-select
                  v-model="form.guaranteeCondition"
                  class="my-1"
                  color="teal-darken-2"
                  density="compact"
                  hide-details="auto"
                ...
                <v-textarea
                  v-model="form.guaranteeConditionRemark"
                  class="my-1"
                  color="teal-darken-2"
                  density="compact"
                  hide-details
                ...
                <div class="d-flex">
                  <div class="w-50">
                    ...
                    <div class="d-flex align-center">
                      ...
                      <v-select
                        v-model="form.riskCategoryThree"
                        class="my-1"
                        color="teal-darken-2"
                        density="compact"
                        hide-details="auto"
                  ...
                  <div class="w-50">
                    <div class="d-flex align-center">
                      ...
                      <v-text-field
                        v-model="form.riskCategoryOnePercentage"
                        class="my-1"
                        color="teal-darken-2"
                        density="compact"
                        hide-details
                    ...
                    <div class="d-flex align-center">
                      ...
                      <v-text-field
                        v-model="form.riskCategoryTwoPercentage"
                        class="my-1"
                        color="teal-darken-2"
                        density="compact"
                        hide-details
                    ...
                    <div class="d-flex align-center">
                      ...
                      <v-text-field
                        v-model="form.riskCategoryThreePercentage"
                        class="my-1"
                        color="teal-darken-2"
                        density="compact"
                        hide-details
                    ...
                    <div class="d-flex align-center">
                      ...
                      <v-text-field
                        v-model="form.riskCategoryFourPercentage"
                        class="my-1"
                        color="teal-darken-2"
                        density="compact"
                        hide-details
...
<script setup lang="ts">
  import type { FormData } from '@/types/amendAdjustment'
  ...
  const form = reactive<FormData>(props.formData || {} as FormData)
  ...
  watch(
    ...
    newVal => {
      ...
      Object.assign(form, newVal || {} as FormData)
      nextTick(() => {
