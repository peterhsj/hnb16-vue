...
<script setup lang="ts">
  import type { ListItem, QueryFormPayload } from '@/types/queryMarDraft'
  import type { DataTableHeader } from 'vuetify'
  import { onMounted, ref, watch } from 'vue'
  import { getDatacList } from '@/api/queryMarDraft'
  ...
  const tableHeaders: DataTableHeader[] = [
    ...
    { title: '受益人名稱', key: 'beneficiaryName', align: 'start', sortable: false, nowrap: true },
    { title: '押匯日期', key: 'draftDate', align: 'center', sortable: false, nowrap: true },
