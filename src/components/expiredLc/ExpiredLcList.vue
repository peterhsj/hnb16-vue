...
<script setup lang="ts">
  import type { ListItem, QueryFormPayload } from '@/types/expiredLc'
  import type { DataTableHeader } from 'vuetify'
  import { computed, onMounted, ref, watch } from 'vue'
  import { getDataList } from '@/api/expiredLc'
  ...
  async function fetchLcAppList () {
    const { lcNo, beneficiaryTaxId, lcStatus, issueDateStart, issueDateEnd } = searchForm.value
