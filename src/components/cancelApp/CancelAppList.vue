...
<script setup lang="ts">
  import type { CancelAppFormPayload, CancelAppItem } from '@/types/cancelApp'
  import type { DataTableHeader } from 'vuetify'
  import { computed, onMounted, ref, watch } from 'vue'
  import { getCancelAppList } from '@/api/cancelApp'
  ...
  interface Props {
    formData?: CancelAppFormPayload
  }
  const props = defineProps<Props>()
  const searchForm = ref<CancelAppFormPayload>(props.formData ?? {
    beneType: 'cds',
    queryMode: '',
    lcNo: '',
  ...
  async function fetchLcAppList () {
    const { lcNo, applicantLoanAccount, beneficiaryTaxId, lcStatus, issueDateStart, issueDateEnd } = searchForm.value as CancelAppFormPayload
