...
<script setup lang="ts">
  import type { ListItem, QueryFormPayload } from '@/types/queryFpcCtsv'
  import type { DataTableHeader } from 'vuetify'
  import { onMounted, ref, watch } from 'vue'
  import { getDatacList } from '@/api/queryFpcCtsv'
  ...
  async function fetchLcAppList () {
    const { transactionType, transactionDateStart, transactionDateEnd } = searchForm.value
    const payload = { transactionType, transactionDateStart, transactionDateEnd }
