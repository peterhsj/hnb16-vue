import type { ListItem, ListResponse, QueryFormPayload } from '@/types/queryBeneficiaryBlcAmount'
...
const mockItems: ListItem[] = Array.from({ length: 5 }, (_, i) => ({
  ...
  electronicDiscountCount: Mock.Random.integer(0, 10),
  electronicDiscountAmount: Mock.Random.integer(0, 1_000_000),
}))

// 查詢未結案信用狀額度與保證金清冊
Mock.mock('/api/queryBeneficiaryBlcAmount/list', 'post', (options: any): ListResponse => {
