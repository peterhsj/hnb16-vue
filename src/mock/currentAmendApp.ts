import type { AmendLcItem, CurrentAmendListResponse, LcTypeOption } from '@/types/currentAmendApp'
...
// 查詢修狀沖正(EC)清冊
Mock.mock('/api/currentAmendApp/list', 'post', (options: any): CurrentAmendListResponse => {
