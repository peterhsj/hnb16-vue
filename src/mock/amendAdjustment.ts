import type { ListItem, ListResponse } from '@/types/amendAdjustment'
...
const mockItems: ListItem[] = Array.from({ length: 15 }, (_, i) => ({
  seqNo: i + 1,
  amendAppNo: i % 4 === 3 ? null : `A${String(2_025_001 + i).padStart(7, '0')}`,
...
// 查詢修狀沖正(EC)清冊
Mock.mock('/api/amendAdjustment/list', 'post', (options: any): ListResponse => {
