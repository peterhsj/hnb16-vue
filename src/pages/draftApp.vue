  ...
  <div>
    ...
    <v-container fluid>
      ...
      <div v-if="isShowList" class="mt-4 mx-4">
        ...
        <draftList :form-data="propsFormData" @on-edit="handleEdit" />
...
<script setup lang="ts">
  ...
  const searchForm = reactive<DraftQueryFormPayload>(createInitialDraftQueryForm())
  const propsFormData = ref<DraftQueryFormPayload>({ ...searchForm })
  const draftLcData = ref<DraftLcData>({ appNo: '' })
