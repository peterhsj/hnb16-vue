  ...
  <div>
    ...
    <v-container fluid>
      ...
      <div v-if="currentView === 'search'">
        <h2 class="mx-4 hnb16__title">查詢修改申請書</h2>
      ...
      <div v-if="isShowList" class="mt-4 mx-4">
        ...
        <QueryAmendAppList :form-data="propsFormData" @on-edit="handleEdit" />
      </div>
    </v-container>
  </div>
</template>
...
<script setup lang="ts">
  import type { LcData, QueryFormPayload } from '@/types/queryAmendApp'
