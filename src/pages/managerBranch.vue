...
<script setup lang="ts">
  ...
  const tableHeaders: DataTableHeader[] = [
    ...
    { title: '分行代碼', key: 'branchCode', align: 'start', sortable: false, nowrap: true },
    { title: '地址', key: 'address', align: 'start', sortable: false, nowrap: true },
    { title: '電話', key: 'phone', align: 'start', sortable: false, nowrap: true },
    { title: '聯絡人', key: 'contactPerson', align: 'start', sortable: false, nowrap: true },
  ...
  const selectedItem = ref<ListItem>({ branchId: '', branchName: '', branchCode: '', address: '', phone: '', contactPerson: '' })
