  ...
  <div>
    ...
    <v-container fluid>
      ...
      <div v-if="currentView === 'search'">
        <h2 class="mx-4 hnb16__title">查詢主管核准開狀紀錄</h2>
      ...
      <div v-if="isShowList" class="mt-4 mx-4">
        ...
        <QueryMarLcList :form-data="propsFormData" />
      </div>
    </v-container>
  </div>
</template>
...
<script setup lang="ts">
  import type { QueryFormPayload } from '@/types/queryMarLc'
