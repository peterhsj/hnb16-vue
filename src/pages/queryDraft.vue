  ...
  <div>
    ...
    <v-container fluid>
      ...
      <div v-if="currentView === 'search'">
        <h2 class="mx-4 hnb16__title">查詢押匯申請</h2>
              ...
              >
                <v-row class="ma-0">
                  ...
                  <v-col class="d-flex align-center ga-4" cols="12" lg="4" md="6">
                    <div class="text-body-1 font-weight-medium text-no-wrap hnb__form-label">今日匯票資料</div>
                    ...
                    <v-text-field
                      ...
                      color="teal-darken-2"
                      density="compact"
                      :disabled="searchForm.queryMode !== 'draft'"
                      hide-details="auto"
                      variant="outlined"
                    />
                  </v-col>
