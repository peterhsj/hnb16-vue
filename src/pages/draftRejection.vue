...
<script setup lang="ts">
  import type { ListItem } from '@/types/draftRejection'
  import type { DataTableHeader } from 'vuetify'
  import { computed, onMounted, ref, watch } from 'vue'
  import { getDatacList } from '@/api/draftRejection'
  import { useApiErrorHandler } from '@/composables/useApiErrorHandler'

  const breadcrumbs = [
    { title: '首頁', href: '/' },
    { title: '電子押匯提示作業' },
    { title: '押匯拒絕原因維護', disabled: true },
  ]
  ...
  const tableHeaders: DataTableHeader[] = [
    { title: '代碼', key: 'code', align: 'center', sortable: false, nowrap: true },
    { title: '拒絕原因', key: 'reason', align: 'start', sortable: false, nowrap: true },
  ...
  const selectedItem = ref<ListItem>({ code: '', reason: '' })
