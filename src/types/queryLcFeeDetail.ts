...
interface ListItem {
  ...
  lcSource: string // 信用狀來源
  applicant: string // 申請人
  beneficiary: string // 受益人
  issueCount: number // 開狀筆數
  issueFeeTotal: number // 開狀手續費總計
  amendCount: number // 修狀筆數
  amendFeeTotal: number // 修狀手續費總計
  acceptanceCount: number // 承兌筆數
  acceptanceFeeTotal: number // 承兌手續費總計
  discountCount: number // 押匯筆數
  discountFeeTotal: number // 押匯手續費總計
}
