...
export interface QueryFormPayload {
  issueDateStart: string // 起始日期
  issueDateEnd: string // 結束日期
  beneficiaryTaxId: string // 帳號
  role: string | null // 角色
  operationItem: string | null // 作業項目
  operationResult: string | null // 作業結果
}
...
interface ListItem {
  ...
  role?: string // 角色
  time?: string // 時間
  operationItem?: string // 操作項目
  operationResult?: string // 作業結果
  operationMessage?: string // 作業訊息
}
