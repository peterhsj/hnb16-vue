...
export type CancelAppStatusLabel = '未到期' | '已到期'
...
export interface CancelAppItem {
  lcNo: string // 信用狀號碼
  ...
  status: CancelAppStatusLabel //
}

export interface CancelAppListSummary {
  total: number
  amount: number
}

export interface CancelAppListResponse {
  items: CancelAppItem[]
  summary: CancelAppListSummary
  page: number
  pageSize: number
  totalPages: number
}

export interface CancelAppListSearchParams {
  page?: number
  pageSize?: number
}
...
export interface CancelAppFormPayload {
...
export function createInitialCancelAppForm (): CancelAppFormPayload {
  return {
    beneType: null, // 受益人類型
...
export interface CancelAppPayload {
  // ── 共用 ────────────────────────────────────────────────────────────────
...
// export function createInitialCancelAppForm (): CancelAppPayload {
//   return {
//     // ── 共用 ──────────────────────────────────────────────────────────────
